...
@Component({
  selector: 'app-fonctionnaire-create-admin',
  templateUrl: './fonctionnaire-create-admin.component.html'
})
export class FonctionnaireCreateAdminComponent extends AbstractCreateController<FonctionnaireDto, FonctionnaireCriteria, FonctionnaireAdminService>  implements OnInit {
